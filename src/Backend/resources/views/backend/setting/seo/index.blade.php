...
@section('title', trans('juzacms::app.seo_setting'))

@section('content')

{{ Breadcrumbs::render('manager', [
        'name' => trans('juzacms::app.seo_setting'),
    ...
    <form action="{{ route('admin.setting.seo.save') }}" method="post" class="form-ajax">
        <div class="card seo-card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="mb-0 card-title font-weight-bold">@lang('juzacms::app.seo_setting')</h5>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        @include('juzacms::backend.setting.seo.form_left')
                    </div>
                    <div class="col-md-6">
                        @include('juzacms::backend.setting.seo.form_right')
                    </div>
                </div>
            </div>
        </div>

<form method="post" action="{{ route('admin.setting.save') }}" class="form-ajax">
    ...
    <div class="form-group">
        <label class="col-form-label" for="stream3s_use">@lang('juzacms::app.stream3s_stream')</label>
        <select name="stream3s_use" id="stream3s_use" class="form-control">
            <option value="1" @if($stream3s_use == 1) selected @endif>@lang('juzacms::app.enabled')</option>
            <option value="0" @if($stream3s_use == 0) selected @endif>@lang('juzacms::app.disabled')</option>
        </select>
    </div>

    <div class="form-group">
        <label class="col-form-label" for="stream3s_link">@lang('juzacms::app.stream3s_link')</label>
    ...
    <div class="form-group">
        <label class="col-form-label" for="stream3s_client_id">@lang('juzacms::app.client_id')</label>
    ...
    <div class="form-group">
        <label class="col-form-label" for="stream3s_secret_key">@lang('juzacms::app.secret_key')</label>

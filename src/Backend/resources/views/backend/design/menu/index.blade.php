...
@section('content')
    ...
    <div class="row mt-5">
        <div class="col-md-4">
            @include('juzaweb::backend.design.menu.form_left')
        </div>

        <div class="col-md-8">
            @include('juzaweb::backend.design.menu.form_right')
        </div>
    </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.design.menu.add') }}" method="post" class="form-ajax">
                    <div class="modal-header">
                        <h4 class="modal-title">{{ trans('juzaweb::app.add_menu') }}</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>

                    <div class="modal-body">
                        <div class="form-group">
                            <label for="menu-name" class="form-label">{{ trans('juzaweb::app.menu_name') }}</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times-circle"></i> {{ trans('juzaweb::app.close') }}</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class='form-group'>
                        <label class="form-label">{{ trans('juzaweb::app.url') }}</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary save-menu-item"><i class="fa fa-save"></i> {{ trans('juzaweb::app.save') }}</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times-circle"></i> {{ trans('juzaweb::app.close') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <template id="menu-item">
        <li class='dd-item' id="item-{id}" data-id="{id}" data-content="{content}" data-object_id="{object_id}" data-url="{url}" data-new_tab="{new_tab}" data-object_type="{object_type}">
            ...
            <div class='float-right item-edit'>
                <a href='javascript:void(0)' class="edit-menu-item" title='{{ trans('juzaweb::app.edit') }}'><i class='fa fa-edit'></i></a>
                <a href='javascript:void(0)' class='text-red remove-menu-item' title='{{ trans('juzaweb::app.remove') }}'><i class='fa fa-times-circle'></i></a>
            </div>
            {children}
        </li>
    </template>
    ...
    <script type="text/javascript" src="{{ asset('juzaweb/styles/js/add-menu.js') }}"></script>
@endsection
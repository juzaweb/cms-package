...
namespace Juzaweb\Cms\Core\Traits;
...
trait PostTypeHookAction
{
    ...
    public function registerTaxonomy($taxonomy, $objectType, $args = [])
    {
        ...
        foreach ($objectTypes as $objectType) {
            ...
            $this->registerPermalink($taxonomy, [
                ...
                'callback' => 'Juzaweb\Cms\\Theme\\Http\\Controllers\\TaxonomyController'
            ]);
        }
    }
    ...
    {
        if (empty($args['model'])) {
            throw new \Exception('Post type model is required. E.x: \\Juzaweb\Cms\\PostType\\Models\\Post.');
        }

...
return [
    ...
    */
    ...
    'version_installed' => \Juzaweb\Cms\Core\Version::getVersion(),
    ...
    */
    ...
    'notifications' => [
        'notifications' => [
            \Juzaweb\Cms\Updater\Notifications\Notifications\UpdateSucceeded::class => ['mail'],
            \Juzaweb\Cms\Updater\Notifications\Notifications\UpdateFailed::class => ['mail'],
            \Juzaweb\Cms\Updater\Notifications\Notifications\UpdateAvailable::class => ['mail'],
        ],
         ...
         */
        'notifiable' => \Juzaweb\Cms\Updater\Notifications\Notifiable::class,

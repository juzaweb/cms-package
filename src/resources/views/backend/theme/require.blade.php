                ...
                <table class="table juzaweb-table">
                    <thead>
                        <tr>
                            ...
                            <th data-field="key">{{ trans('juzaweb::app.code') }}</th>
                            <th data-field="version" data-width="10%">{{ trans('juzaweb::app.version') }}</th>
                            <th data-field="status" data-width="10%" data-formatter="status_formatter">{{ trans('juzaweb::app.status') }}</th>
                        </tr>
                    </thead>
                </table>
            </div>

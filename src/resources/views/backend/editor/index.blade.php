...
<html class="no-js">
<head>
    <link rel="shortcut icon" href="{{ asset('vendor/juzaweb/styles/images/brand/favicon.ico') }}">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <title>{{ trans('juzaweb::app.customize_theme') }}</title>
    <meta name="description" content="{{ trans('juzaweb::app.customize_theme') }}">
    <meta name="csrf-token" content="{{ csrf_token() }}"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
    @include('juzaweb::components.juzaweb_langs')

    <link rel="stylesheet" href="{{ asset('vendor/juzaweb/styles/css/theme-editor.css') }}">
    <!--[if lt IE 9]>
    <script src="{{ asset('vendor/juzaweb/styles/js/html5shiv.min.js') }}"></script>
    <script src="{{ asset('vendor/juzaweb/styles/js/respond.min.js') }}"></script>
    <![endif]-->

    <script src="{{ asset('vendor/juzaweb/styles/js/theme-editor.js') }}"></script>
                ...
                <div class="te-top-bar__list">
                    <div class="te-top-bar__item te-top-bar__item--fill">
                        ...
                        <h2 class="ui-heading theme-editor__heading text-uppercase">
                            {{ trans('juzaweb::app.theme_editor') }}
                        </h2>

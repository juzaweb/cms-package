<form method="post" action="{{ route('admin.setting.save') }}" class="form-ajax">
    ...
    <div class="form-group">
        <label class="col-form-label" for="google_recaptcha">@lang('juzaweb::app.google_recaptcha')</label>
        <select name="google_recaptcha" id="google_recaptcha" class="form-control">
            <option value="1" @if($google_recaptcha == 1) selected @endif>@lang('juzaweb::app.enabled')</option>
            <option value="0" @if($google_recaptcha == 0) selected @endif>@lang('juzaweb::app.disabled')</option>
        </select>
    </div>

    <div class="form-group">
        <label class="col-form-label" for="google_recaptcha_key">@lang('juzaweb::app.google_recaptcha_key')</label>
    ...
    <div class="form-group">
        <label class="col-form-label" for="google_recaptcha_secret">@lang('juzaweb::app.google_recaptcha_secret')</label>

<div class="card">
    <div class="height-200 d-flex flex-column jw__g13__head" style="background-image: url('{{ $item->image }}')">
    </div>
        ...
        <div class="card-header border-bottom-0">
            <div class="d-flex">
                ...
                <div class="text-gray-6">
                    ...
                    <button class="btn btn-primary install-theme" data-theme="{{ $item->code }}"><i class="fa fa-check"></i> {{ trans('juzaweb::app.install') }}</button>
                    @else

...
<h5>@lang('juzaweb::app.seo_and_marketing')</h5>

<div class="form-group">
    <label class="col-form-label" for="meta_title">@lang('juzaweb::app.meta_title')</label>
    <input type="text" name="meta_title" id="meta_title" class="form-control" autocomplete="off" value="{{ $model->meta_title }}">
</div>

<div class="form-group">
    <label class="col-form-label" for="slug">@lang('juzaweb::app.meta_description')</label>
...
<div class="form-group">
    ...
    <p class="description">@lang('juzaweb::app.use_comma_to_separate_keyword')</p>
</div>

<div class="form-group">
    <label class="col-form-label" for="slug">@lang('juzaweb::app.slug')</label>
